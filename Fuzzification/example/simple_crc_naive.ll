; ModuleID = 'simple_crc.cpp'
source_filename = "simple_crc.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_simple_crc.cpp, i8* null }]
...
define dso_local noundef i32 @_Z7reversej(i32 noundef %0) #4 {
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local noundef i32 @_Z5crc32Pc(i8* noundef %0) #4 {
  %2 = alloca i8*, align 8
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local i32 @modifyInt(i32 noundef %0) #4 {
  %2 = alloca i32, align 4
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local double @modifyDouble(double noundef %0) #4 {
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local float @modifyFloat(float noundef %0) #4 {
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local i32 @retWrapInt(i32 noundef %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca [200 x i8], align 1
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local double @retWrapDouble(double noundef %0) #4 {
  %2 = alloca double, align 8
  %3 = alloca [200 x i8], align 1
  %4 = alloca double, align 8
  %5 = alloca double, align 8
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local float @retWrapFloat(float noundef %0) #4 {
  %2 = alloca float, align 4
  %3 = alloca [200 x i8], align 1
  %4 = alloca float, align 4
  %5 = alloca float, align 4
...
define dso_local noundef i32 @main(i32 noundef %0, i8** noundef %1) #5 {
  ...
  %10 = call i32 @modifyInt(i32 noundef %9)
  %11 = call i32 @modifyInt(i32 noundef 0)
...
14:                                               ; preds = %13, %2
  ...
  %17 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %16, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_simple_crc.cpp() #0 section ".text.startup" {
